          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text('ZAROBKI', style: TextStyle(color: Colors.white),),
                Text('${Provider.of<AppData>(context).earnings} PLN', style: TextStyle(color: Colors.white, fontSize: 40, fontFamily: 'Brand-Bold'),)
              ],
            ),
          ),
        ),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 16,),
                Text('Przejazdy', style: TextStyle(fontSize: 16), ),
