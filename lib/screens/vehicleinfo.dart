              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text('Wprowadź informacje o pojeździe', style: TextStyle(fontFamily: 'Brand-Bold', fontSize: 20),),
                    ...
                    TaxiButton(
                      ...
                      onPressed: (){
                        ...
                        if(carModelController.text.length < 3){
                          showSnackBar('Wprowadź model samochodu');
                          return;
                        }
                        ...
                        if(vehicleNumberController.text.length < 3){
                          showSnackBar('Wprowadź numer rejestracyjny samochodu');
                          return;
                        }
